        ...
        <div className="mb-5 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl dark:text-white">
              Clean, simple, and easier to scan.
            </h2>
          </div>

          <p className="max-w-2xl text-sm leading-7 text-slate-500 dark:text-slate-300">
            The amenities row now works better as a supporting strip after the stat banner and before the venue spaces showcase.
          </p>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-6">
          {amenities.map((item) => {
            ...
            return (
              <div
                key={item.label}
                className="rounded-[1.5rem] border border-black/5 bg-[#f8f4ea] px-4 py-5 text-center dark:border-white/10 dark:bg-slate-900/70"
              >
