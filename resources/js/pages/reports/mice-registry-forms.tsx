...
export default function MiceRegistryForm() {
  ...
  const record = useMemo<MiceRegistryRecord | undefined>(() => {
    return props.record ?? props.miceRecord ?? props.registryRecord ?? props.row ?? props.item;
  }, [props.record, props.miceRecord, props.registryRecord, props.row, props.item]);

  const editing = Boolean(record?.id);

  const { data, setData, post, put, processing, errors } = useForm<MiceRegistryFormData>({
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...data,
      total_employees: String(computedTotalEmployees || data.total_employees || ''),
    };
  ...
  return (
    <ResourcePageShell
      ...
      title={editing ? 'Edit MICE Registry Record' : 'New MICE Registry Record'}
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    Basic classification and enterprise information for the registry.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
              ...
              <Field label="Enterprise Group" error={errors.enterprise_group}>
                ...
                >
                  {enterpriseGroupOptions().map((option) => (
                    <option key={option || 'blank'} value={option}>
                      {option || 'Select enterprise group'}
                    </option>
                  ))}
                </select>
              </Field>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    Location details used for MICE and tourism reporting.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
          ...
          <Card className="backend-admin-card">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    Encode total employees or split the count by male/female employees.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            ...
            <CardContent className="grid gap-4 md:grid-cols-3">
              ...
              <Field label="Total Employees" error={errors.total_employees}>
                <input
                  value={String(computedTotalEmployees || data.total_employees)}
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    Mark applicable compliance and membership information.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
          ...
          <Card className="backend-admin-card">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <Badge variant="outline">Reporting Details</Badge>
                  ...
                  <CardDescription>
                    Add reporting period, contact details, and optional remarks.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
        ...
        <aside className="space-y-6">
          <Card className="backend-admin-card sticky top-24">
            <CardHeader>
              ...
              <CardDescription>
                Quick preview of the encoded registry information.
              </CardDescription>
            </CardHeader>

            <CardContent className="space-y-4">
              <SummaryItem label="Classification" value={data.classification || '—'} />
              <SummaryItem label="Business Type" value={data.business_type || '—'} />
              <SummaryItem label="Enterprise Group" value={data.enterprise_group || '—'} />
              <SummaryItem label="Location" value={data.city_municipality || '—'} />
              <SummaryItem label="Year" value={data.year_recorded || '—'} />
              <SummaryItem label="Employees" value={computedTotalEmployees || 0} />
              ...
              <div className="grid gap-2">
                ...
                >
                  Permit: {data.permit_to_engage ? 'Yes' : 'No'}
                </Badge>
                ...
                >
                  DOT Accredited: {data.dot_accredited ? 'Yes' : 'No'}
                </Badge>
                ...
                >
                  Active Member: {data.active_member ? 'Yes' : 'No'}
                </Badge>
              </div>
            </CardContent>
          </Card>
